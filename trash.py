class GeniaConfig(Config):
    defn = (
        "An entity is a protein (protein), group of proteins (protein), DNA, RNA, Cell Type (cell_type) or Cell Line (cell_line). "
...
class FewNERDConfig(Config):
    ...
    art = "piece of art"
    miscellaneous = (
        "product, language, living thing, currency, god or scientific concept in astronomy, biology etc. "
    )
    locations = (
        "locations with the following types of locations - Country(location-GPE), Province/State(location-GPE), "
